...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-slate-100 bg-white text-slate-950 shadow-sm shadow-slate-200/50 transition-all duration-200 hover:shadow-md hover:shadow-slate-200/60",
      className
    )}
    {...props}
  />
